...
namespace RRLab.PhysiologyWorkbench.Devices
{
	...
	public class SpectraPhysicsNitrogenLaser : RRLab.PhysiologyWorkbench.Devices.Device
	{
        ...
        private double _MinimumChargingTime = 15;

        public double MinimumChargingTime
        {
		...
		/// </summary>
		/// <param name="TriggerDO">The DAQmx address for the TriggerDO line.</param>
		/// <param name="BurstDO">The DAQmx address for the BurstDO line.</param>
		/// <param name="OptosyncPFI">The DAQmx address for the OptosyncPFI trigger.</param>
		/// <param name="PowerAI">The DAQmx address for the Laser Power AI.</param>
		/// <param name="PowerMin">The minimum input voltage for PowerAI.</param>
		/// <param name="PowerMax">The maximum input voltage for PowerAI.</param>
		/// <param name="Wavelength">The wavelength (in nm) of this laser.</param>
		...
		/// </summary>
		/// <param name="hz">The frequency to fire the laser (in Hz).</param>
		/// <param name="t">The length of time to fire the laser (in ms).</param>
		/// <param name="sampleRate">The sampling rate to use (in Hz).</param>
		/// <param name="clock">The DAQmx address of the sample clock to use.</param>
		/// <param name="clockEdge">The clock edge to use.</param>
		...
		///	given Task <c>task</c>.
		/// </summary>
		/// <param name="task">The task to generate the channels within.</param>
		...
		/// <summary>
		/// <c>DisposeOfChannels()</c> frees up the channel variables created in
