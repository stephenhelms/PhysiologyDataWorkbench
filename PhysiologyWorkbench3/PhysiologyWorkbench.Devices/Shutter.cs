...
namespace RRLab.PhysiologyWorkbench.Devices
{
	...
	public class Shutter : RRLab.PhysiologyWorkbench.Devices.Device
	{
		...
		/// </summary>
		/// <param name="OpenLine">The DAQmx address of the Open line.</param>
		/// <param name="CloseLine">The DAQmx address of the Close line.</param>
		...
		/// <param name="OpenLine">The DAQmx address of the Open line.</param>
		/// <param name="CloseLine">The DAQmx address of the Close line.</param>
		/// <param name="Name">An identifier for this shutter.</param>
		...
		/// </summary>
		/// <param name="taskName">The task to use.</param>
		/// <param name="line">The DAQmx address for the digital line to write to.</param>
		/// <param name="lineName">A name for the digital line.</param>
		/// <param name="sample1">The first sample to send.</param>
		/// <param name="sample2">The second sample to send.</param>
