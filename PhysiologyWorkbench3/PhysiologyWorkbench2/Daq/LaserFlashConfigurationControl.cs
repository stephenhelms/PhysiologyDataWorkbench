...
{
    public partial class LaserFlashConfigurationControl : UserControl
    {
        ...
        private LaserFlashProtocol _Protocol;

        public LaserFlashProtocol Protocol
        {
        ...
        public LaserFlashConfigurationControl()
        {
            InitializeComponent();
        }
        public LaserFlashConfigurationControl(LaserFlashProtocol protocol)
        {
            InitializeComponent();
            Protocol = protocol;
        }
