    ...
    public partial class TestPulseSidebar : UserControl
    {
        ...
        public TestPulseProtocol Protocol
        {
            ...
            set {
                ...
                TestPulseSettingsBox.TestPulseProtocol = Protocol;
                TestPulseSealResistanceMonitor.TestPulseProtocol = Protocol;
                TestPulseSealResistanceTank.TestPulseProtocol = Protocol;
