...
namespace RRLab.PhysiologyWorkbench.Devices
{
	...
	public class Shutter : RRLab.PhysiologyWorkbench.Devices.Device
	{
        ...
        public override void InitializeDevice()
        {
            try
            {
                if (IsShutterClosedByDefault) CloseShutter();
                else OpenShutter();
            }
            catch (Exception x)
            {
        ...
        public bool IsShutterClosed 
		{
			...
			set 
			{
                ...
                if(ShutterToggled != null)
                    ...
                    {
                        System.Diagnostics.Debug.Fail("Error during ShutterToggled event.", x.Message);
                    }
			}
		}


        private bool _IsShutterClosedByDefault = false;

        public bool IsShutterClosedByDefault
        {
            get { return _IsShutterClosedByDefault; }
            set { _IsShutterClosedByDefault = value; }
        }
