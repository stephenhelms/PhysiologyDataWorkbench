...
namespace RRLab.PhysiologyWorkbench.GUI
{
    public partial class ProtocolExecutionControl : UserControl
    {
        ...
        public DataManager DataManager
        {
            ...
            {
                _DataManager = value;
                if (DataManager != null && Protocol != null)
                    Protocol.Program = DataManager.Program;
        ...
        public DaqProtocol Protocol
        {
            ...
            set
            {
                ...
                if (Protocol != null)
                {
                    if(DataManager != null) Protocol.Program = DataManager.Program;
        ...
        private void TrashButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataManager.RemoveRecording(Protocol.Data);
                TrashButton.Enabled = false;
            }
            catch (Exception x)
            {
        ...
        protected virtual void OnProtocolDataUpdated(object sender, EventArgs e)
        {
            ...
            try
            {
                DataManager.StoreRecording(Protocol.Data);
                TrashButton.Enabled = true;
            }
            catch (Exception x)
            {
