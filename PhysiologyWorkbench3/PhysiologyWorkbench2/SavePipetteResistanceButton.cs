...
{
    public partial class SavePipetteResistanceButton : UserControl
    {
        ...
        public SavePipetteResistanceButton()
        {
            InitializeComponent();
        }
        ...
        protected virtual void OnResistanceMeasured(object sender, EventArgs e)
        {
            ...
            UpdateView();
            if ((DataManager != null) && (DataManager.CurrentCell != null) && (DataManager.CurrentCell.PipetteResistance == 0))
        ...
        public virtual void SaveResistance()
        {
            ...
            DataManager.CurrentCell.PipetteResistance = (float) (TestPulseProtocol.Resistance * 1E3);
            if (DataManager.CurrentRecording != null)
                DataManager.CurrentRecording.Description = "Test pulse in bath configuration. Autosaved pipette resistance.";
